...
def collect_all():
    ...
    from scripts.data_collection.drugbank_parser import save_drugbank_data
    drugs = save_drugbank_data()
    all_documents.extend(drugs)

    # ── Step 2: Disease-Symptom Dataset ──
    print("\n[2/5] Generating disease-symptom dataset...")
    from scripts.data_collection.disease_symptom_loader import save_disease_data
    ...
    from scripts.data_collection.who_guidelines_loader import save_who_guidelines
    ...
    if os.path.exists(pubmed_path):
        ...
        print("    python scripts/data_collection/pubmed_scraper.py")
    ...
    if os.path.exists(fda_path):
        ...
        print("    python scripts/data_collection/fda_scraper.py")
